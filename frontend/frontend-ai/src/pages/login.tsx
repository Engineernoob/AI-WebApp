...
import { LogIn, Lock, Mail, Github, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900">Welcome to Silas AI</h2>
        ...
        <div className="space-y-4">
          ...
          <Link 
            href="/" 
            className="flex items-center justify-center text-sm text-gray-500 hover:text-gray-700 transition-colors duration-200"
          >
